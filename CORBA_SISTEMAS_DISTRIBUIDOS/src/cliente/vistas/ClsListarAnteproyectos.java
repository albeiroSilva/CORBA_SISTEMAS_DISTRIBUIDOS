...
public class ClsListarAnteproyectos extends javax.swing.JFrame {
    ...
    public ClsListarAnteproyectos(GestionAnteproyectosOperations objRemoto) throws RemoteException {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int tamanio = listaAnteproyectos.length;
        String nombreColumnas [] = {"Código","Título"};
        String data[][] =  new String[tamanio][2];
        for (int i = 0; i < listaAnteproyectos.length; i++) {
            
           
             data[i][0] = Integer.toString(listaAnteproyectos[i].getCodigo());
             data[i][1] = listaAnteproyectos[i].getTitulo();
